...
window.addEventListener("scroll", function () {
  ...
  function changecarrosel() {
    ...
    if (number == 2) {
      ...
      desc.innerHTML = `
      <div onclick="window.open('https://youtu.be/5I3DKGG0xjU?si=XsIqh6uj6ybnQeRr', '_blank')" style="cursor: pointer;">
        <h2 class="redbull">Broski Qualifies For Capcom Cup</h2>
      </div>
    `;
    ...
    if (number == 3) {
      desc.innerHTML = `
        <div class = 'leftthird'>
        <h3>Watch High Level Aki Replays</h3>
        <a href= "https://www.youtube.com/playlist?list=PLvZ5t8JLwU9Ly7fIlPDOobExANmvKjr4c" target = "_blank">
