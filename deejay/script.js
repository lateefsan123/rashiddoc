...
window.addEventListener("scroll", function () {
  ...
  function changecarrosel() {
    ...
    if (number == 2) {
      ...
      desc.innerHTML = `
      <div onclick="window.open('https://youtu.be/_pMYkGdDBuc?feature=shared', '_blank')" style="cursor: pointer;">
        <h2 class="redbull">Fuudo cpt japan run</h2>
      </div>
    `;
    ...
    if (number == 3) {
      desc.innerHTML = `
        <div class = 'leftthird'>
        <h3>Watch High Level Dee Jay Replays</h3>
        <a href= "https://youtube.com/playlist?list=PLvZ5t8JLwU9KffcH76iRHp8xkk_td2P3f&si=kK8yS-mSNSAUGJgw" target = "_blank">
