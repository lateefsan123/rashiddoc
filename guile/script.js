...
window.addEventListener("scroll", function () {
  ...
  function changecarrosel() {
    ...
    if (number == 2) {
      ...
      desc.innerHTML = `
      <div onclick="window.open('https://www.youtube.com/live/2h701TmYy80?si=XXXFr7-UpzuH6d5I&t=6227', '_blank')" style="cursor: pointer;">
        <h2 class="redbull">Higuchi Asian Champions League</h2>
      </div>
    `;
    ...
    if (number == 3) {
      desc.innerHTML = `
        <div class = 'leftthird'>
        <h3>Watch High Level Guile Replays</h3>
        <a href= "https://www.youtube.com/playlist?list=PLvZ5t8JLwU9LbBqvY5gLGQkh0R47e_EZL" target = "_blank">
