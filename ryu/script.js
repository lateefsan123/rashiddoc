...
window.addEventListener("scroll", function () {
  ...
  function changecarrosel() {
    ...
    if (number == 2) {
      ...
      desc.innerHTML = `
      <div onclick="window.open('https://www.youtube.com/embed/iHFMMPELRhA?si=EBD16EnVwBE7KnAs', '_blank')" style="cursor: pointer;">
        <h2 class="redbull">Blaz Capcom Cup run</h2>
      </div>
    `;
    ...
    if (number == 3) {
      desc.innerHTML = `
        <div class = 'leftthird'>
        <h3>Watch High Level Ryu Replays</h3>
        <a href= "https://www.youtube.com/playlist?list=PLvZ5t8JLwU9IXbcuvqGhm2KvTLMBA0iNL" target = "_blank">
