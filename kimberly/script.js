...
window.addEventListener("scroll", function () {
  ...
  function changecarrosel() {
    ...
    if (number == 2) {
      ...
      desc.innerHTML = `
      <div onclick="window.open('https://youtu.be/n2tOCTIL4QA?si=RzIOiNJsi6yPopln', '_blank')" style="cursor: pointer;">
        <h2 class="redbull">Narikun Bam melbourne win</h2>
      </div>
    `;
    ...
    if (number == 3) {
      desc.innerHTML = `
        <div class = 'leftthird'>
        <h3>Watch High Level Kimberly Replays</h3>
        <a href= "https://www.youtube.com/playlist?list=PLvZ5t8JLwU9K1p3AQg1ZZJyXt9kh8EHkQ" target = "_blank">
