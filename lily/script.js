...
window.addEventListener("scroll", function () {
  ...
  function changecarrosel() {
    ...
    if (number == 2) {
      ...
      desc.innerHTML = `
      <div onclick="window.open('https://youtu.be/QXdQRItxK9w?si=RFFh7Cya3_F8MGXX', '_blank')" style="cursor: pointer;">
        <h2 class="redbull">El Chakotay Combo Breaker</h2>
      </div>
    `;
    ...
    if (number == 3) {
      desc.innerHTML = `
        <div class = 'leftthird'>
        <h3>Watch High Level Lily Replays</h3>
        <a href= "https://www.youtube.com/playlist?list=PLvZ5t8JLwU9IQ3zbd9gmT73x4AfYi9P6p" target = "_blank">
