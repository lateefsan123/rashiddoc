...
window.addEventListener("scroll", function () {
  ...
  function changecarrosel() {
    ...
    if (number == 2) {
      ...
      desc.innerHTML = `
      <div onclick="window.open('https://youtu.be/CN-Pp9t7bJU?si=2ICN_-R2zG3wvOPh', '_blank')" style="cursor: pointer;">
        <h2 class="redbull">Idom Qualifies for Camcom Cup</h2>
      </div>
    `;
    ...
    if (number == 3) {
      desc.innerHTML = `
        <div class = 'leftthird'>
        <h3>Watch High Level Manon Replays</h3>
        <a href= "https://www.youtube.com/playlist?list=PLvZ5t8JLwU9KXDa9spT_GucTabWKAgPnO" target = "_blank">
